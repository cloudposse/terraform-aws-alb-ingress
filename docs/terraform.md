...
| [aws_lb_listener_rule.unauthenticated_hosts_fixed_response](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
...
| [aws_lb_listener_rule.unauthenticated_hosts_paths_fixed_response](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
...
| [aws_lb_listener_rule.unauthenticated_paths_fixed_response](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener_rule) | resource |
...
| <a name="input_content_type"></a> [content\_type](#input\_content\_type) | The content type (for fixed\_response action). Valid values are text/plain, text/css, text/html, application/javascript and application/json. | `string` | `""` | no |
...
| <a name="input_message_body"></a> [message\_body](#input\_message\_body) | The message body (for fixed\_response action). | `string` | `null` | no |
...
| <a name="input_status_code"></a> [status\_code](#input\_status\_code) | The HTTP response code (for fixed\_response action). Valid values are 2XX, 4XX, or 5XX. | `number` | `null` | no |
