...
resource "aws_lb_listener_rule" "unauthenticated_paths" {
  count = module.this.enabled && var.content_type == "" && length(var.unauthenticated_paths) > 0 && length(var.unauthenticated_hosts) == 0 ? length(var.unauthenticated_listener_arns) : 0
...
resource "aws_lb_listener_rule" "unauthenticated_hosts" {
  count = module.this.enabled && var.content_type == "" && length(var.unauthenticated_hosts) > 0 && length(var.unauthenticated_paths) == 0 ? length(var.unauthenticated_listener_arns) : 0
...
resource "aws_lb_listener_rule" "unauthenticated_paths_fixed_response" {
  count = module.this.enabled && var.content_type != "" && length(var.unauthenticated_paths) > 0 && length(var.unauthenticated_hosts) == 0 ? length(var.unauthenticated_listener_arns) : 0
...
resource "aws_lb_listener_rule" "unauthenticated_hosts_fixed_response" {
  count = module.this.enabled && var.content_type != "" && length(var.unauthenticated_hosts) > 0 && length(var.unauthenticated_paths) == 0 ? length(var.unauthenticated_listener_arns) : 0
...
resource "aws_lb_listener_rule" "unauthenticated_hosts_paths_fixed_response" {
  count = module.this.enabled && var.content_type != "" && length(var.unauthenticated_paths) > 0 && length(var.unauthenticated_hosts) > 0 ? length(var.unauthenticated_listener_arns) : 0
